#PBS -N r200-conf-aware
#PBS -q umagpu
#PBS -e logs/r200-conf-aware.err
#PBS -o logs/r200-conf-aware.out
...
# Train
# $PY main.py train -i r200d -j jakiro/sin_exp5_r200d_rarex2.yaml
$PY main_cp.py train -i r200d -j jakiro/sin_exp5_r200d_rarex2.yaml
